...
<div id="contact-form" class="col-xs-12 col-sm-12 col-md-offset-1 col-sm-offset-1 col-lg-offset-1 col-sm-5 col-md-5 col-lg-5">
    ...
    <form id="contact-form" action="<?php echo base_url('index.php/home/sendmail')?>" method="post">
        <div class="hidden-sm-down form-group row-flex align-items-center">
            <label for="sender-name" class="name control-label label-sender col-md-3 col-lg-3">Nombres*</label>
            <div class="col-sm-9 col-md-9 col-lg-9"><input type="text" class="form-control" name="nombres" required></div>
        </div>
        <div class="hidden-sm-down form-group row-flex align-items-center">
        ...
        <div class="hidden-sm-down form-group row-flex align-items-center">
            ...
            <div class="col-sm-9 col-md-9 col-lg-9"><input type="email" class="form-control" name="email" required></div>
        </div>
        <div class="hidden-sm-down form-group row-flex align-items-center">
        ...
        <div class="hidden-sm-down form-group row-flex align-items-cente">
            ...
            <div class="col-sm-9 col-md-9 col-lg-9"><textarea id="message" class="form-control" name="mensaje" required></textarea></div>
        </div>
...
<div class="col-xs-12 col-sm-12 col-md-offset-1 col-lg-offset-1 col-md-5 col-lg-5">
    <form id="contact-form" action="<?php echo base_url('index.php/home/sendmail')?>" method="post">
        <label for="sender-name" class="hidden-md-up name control-label label-sender col-xs-12 col-sm-12">Nombres*</label>
        <div class="hidden-md-up col-xs-12 col-sm-12"><input type="text" class="form-control" name="nombres" required></div>
        ...
        <div class="hidden-md-up col-xs-12 col-sm-12"><input type="email" class="form-control" name="email" required></div>
        ...
        <div class="hidden-md-up col-xs-12 col-sm-12"><textarea id="message" class="form-control" name="mensaje" required></textarea></div>
