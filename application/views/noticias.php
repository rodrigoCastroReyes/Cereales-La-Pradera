...
<div class="principal-body">
    <div class="principal-body-noticias">
        <div id="logo" class="hidden-xs">
            <img id="img-logo"  src="images/logoPortada.png" />
        </div>
        <div id="images-div" class="hidden-xs col-sm-offset-2 col-sm-8 col-md-offset-2 col-md-8">
            <img class="img-responsive" src="images/noticias/noticias.jpg" />
        </div>
        ...
        <div class="col-sm-offset-2 col-md-offset-2 col-sm-8 col-md-8 col-xs-12">
            <div class="col-xs-12 col-md-4 col-sm-4">
                <div class="thumbnail">
                    <a href="./que-es-cilaquia.html">
                        <img class="img-responsive" src="./images/noticias/celiaquia.jpg" alt="noticias">
                    </a>
                    <div class="caption">
            ...
            <div class="col-xs-12 col-md-4 col-sm-4">
                <div class="thumbnail">
                    <a href="./alimentos-sin-gluten.html">
                        <img class="img-responsive" src="./images/noticias/popcorn.jpg" alt="noticias">
                    </a>
                    <div class="caption">
