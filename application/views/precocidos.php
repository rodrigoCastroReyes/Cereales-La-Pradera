...
<head>
    ...
    <script>
        $(function () {
            ...
            $('#pop_up_ilustracion').modal('show');

            $("#pop_up_ilustracion").on('hidden.bs.modal', function (e) {
...
<body>
<div class="modal fade" id="pop_up_ilustracion">
    <div id="pop_up_container" class="modal-content embed-responsive col-xs-10 col-sm-8 col-md-4">
        <div class="pop_up">
...
<div class="procesados-main hidden-md-up">
    <div class="principal-body">
        ...
        <div id="buttons_bar" class="text-center">
            <span class="btn-custom" style="margin-right: 1%">Precocidos</span>
            <a class="btn-custom" href="<?php echo base_url('index.php/home/procesados')?>">Procesados</a>
        </div>
        <div class="description">
            <h1 class="title">Precocidos</h1>
            <div class="description-info"><b>La línea de Precocidos de Cereales La Pradera</b>
                permite ahorrar tiempo en la cocina en la elaboración de deliciosos platos
                como tortillas de maíz, pan de quinua, morocho o quippes. Estos productos,
                con materia prima de alta calidad, son de fácil preparación y ricos en nutrientes.
            </div>
        </div>
            ...
            <div class="product-description col-xs-11">
                <div class="col-xs-12">
                    <div class="container-image col-xs-6">
                        <img class="image-pic" src="<?php echo base_url('assets/images/precocidos/Morocho-precocido.jpg')?>"/>
                        <div class="image-title text-center">Morocho</div>
                        <div class="product-value text-center"><b>PACK X 500 G</b></div>
                    </div>
                    <div class="container-image col-xs-6">
                        <img class="image-pic" src="<?php echo base_url('assets/images/precocidos/Humitas.jpg')?>"/>
                        <div class="image-title text-center">Humitas</div>
                        <div class="product-value text-center"><b>PACK X 500 G</b></div>
                    </div>
                </div>
                <div class="col-xs-12">
                    <div class="container-image col-xs-6">
                        <img class="image-pic" src="<?php echo base_url('assets/images/precocidos/Maizarepa2.jpg')?>"/>
                        <div class="image-title text-center">Maíz Arepa Amarilla</div>
                        <div class="product-value text-center"><b>PACK X 250 G</b></div>
                        <div class="product-value text-center"><b>PACK X 500 G</b></div>
                    </div>
                    <div class="container-image col-xs-6">
                        <img class="image-pic" src="<?php echo base_url('assets/images/precocidos/Maizarepa.jpg')?>"/>
                        <div class="image-title text-center">Maíz Arepa Blanca</div>
                        <div class="product-value text-center"><b>PACK X 250 G</b></div>
                        <div class="product-value text-center"><b>PACK X 500 G</b></div>
                    </div>
                </div>
                <div class="col-xs-12">
                    <div class="container-image col-xs-6">
                        <img class="image-pic" src="<?php echo base_url('assets/images/precocidos/Harina-precocida-maiz.jpg')?>"/>
                        <div class="image-title text-center">Maizpa todo amarilla</div>
                        <div class="product-value text-center"><b>PACK X 250 G</b></div>
                        <div class="product-value text-center"><b>PACK X 500 G</b></div>
                    </div>
                </div>
    ...
    <div class="principal-body">
        ...
        <div class="row-floating buttons-container column-flex justify-content-center">
            <div class="institucional-container column-flex justify-content-space-between">
                <span class="btn-custom row-flex align-items-center justify-content-center">Precocidos</span>
            </div>
            <div class="institucional-container column-flex justify-content-space-between" style="margin-top: 10%">
                <a class="btn-custom row-flex align-items-center justify-content-center" href="<?php echo base_url('index.php/home/procesados')?>">Procesados</a>
            </div>
        </div>
        <div class="logo-container"></div>
        <div class="row description-container">
            <div class="title">Precocidos</div>
            <div class="description-info"><b>La línea de Precocidos de Cereales La Pradera</b>
                permite ahorrar tiempo en la cocina en la elaboración de deliciosos platos
                como tortillas de maíz, pan de quinua, morocho o quippes. Estos productos,
                con materia prima de alta calidad, son de fácil preparación y ricos en nutrientes.
        ...
        <div class="row product-container">
            <div class="product-list">
                ...
                <div class="product-description">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="container-image col-sm-offset-3 col-sm-2 col-md-offset-3 col-md-2">
                            <img class="image-pic" src="<?php echo base_url('assets/images/precocidos/Maizarepa2.jpg')?>"/>
                            <div class="image-title text-center">Maíz Arepa Amarilla</div>
                            <div class="product-value text-center"><b>PACK X 250 G</b></div>
                            <div class="product-value text-center"><b>PACK X 500 G</b></div>
